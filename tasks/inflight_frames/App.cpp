  ...
  , useVsync{true}
{
  ...
  etna::create_program("localShader", {INFLIGHT_FRAMES_SHADERS_ROOT "texture.comp.spv"});
  ...
  for (unsigned int i = 0; i < 3; ++i) {
    paramsBuffers.push_back(etna::get_context().createBuffer(etna::Buffer::CreateInfo{
      .size = sizeof(App::Params),
...
void App::drawFrame()
{
  ...
  if (nextSwapchainImage)
  {
    ...
    ETNA_CHECK_VK_RESULT(currentCmdBuf.begin(vk::CommandBufferBeginInfo{}));
    {
      ...
      // TODO: Record your commands here!
        auto set = etna::create_descriptor_set(
          ...
          currentCmdBuf,
          {
            ...
            etna::Binding{1, paramsBuffers[frame % 3].genBinding()}
          });

        ETNA_PROFILE_GPU(currentCmdBuf, "Proceudarl texture set");
        ...
        std::memcpy(paramsBuffers[frame % 3].data(), &params, sizeof(App::Params));
      ...
      ETNA_PROFILE_GPU(currentCmdBuf, "dispatch");
      
      {
        ...
        auto set2 = etna::create_descriptor_set(
          ...
          currentCmdBuf,
          {
            ...
            etna::Binding{2, paramsBuffers[frame % 3].genBinding()}
          });

        ETNA_PROFILE_GPU(currentCmdBuf, "set2");
